...
INSERT INTO problems (title, slug, description, difficulty, category, points, acceptance_rate, total_submissions, solved_count) VALUES
...
INSERT INTO contests (title, description, start_date, end_date, status, participants_count) VALUES
('CodeArena Championship 2025', 'Le plus grand concours de programmation de l''année avec des prix exceptionnels', '2025-01-15 14:00:00', '2025-01-15 17:00:00', 'upcoming', 2847),
('Weekly Challenge #47', 'Défi hebdomadaire avec 5 problèmes de difficulté croissante', '2024-12-28 10:00:00', '2024-12-28 12:00:00', 'active', 1523),
('Algorithmes Avancés', 'Concours spécialisé sur les algorithmes complexes', '2024-12-20 09:00:00', '2024-12-20 13:00:00', 'completed', 3421);
